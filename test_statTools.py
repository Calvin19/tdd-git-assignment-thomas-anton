...
def test_upper_q_6():
    assert (upper_quartile(test_list_6) == 2)  # general case--returns item from index in list


def test_upper_q_7():
    assert (upper_quartile(test_list_7) == 1)  # general case--returns item from index in list
...
def test_median_2():
    assert (median(test_list_2) == 3.5)  # corner case -- median is the average of 2 numbers
...
def test_median_4():
    assert (median(test_list_4) == 5)  # general case--returns item from index in list


def test_median_5():
    assert (median(test_list_5) == 2)  # general case--returns item from index in list


def test_median_6():
    assert (median(test_list_6) == 1.5)  # corner case -- median is the average of 2 numbers


def test_median_7():  # general case--returns item from index in list
